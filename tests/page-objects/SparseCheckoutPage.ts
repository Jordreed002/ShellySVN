...
export class CheckoutDialog {
  ...
  constructor(page: Page) {
    ...
    this.urlInput = this.modal.locator('input[placeholder*="svn"], input[placeholder*="URL"]').first()
    this.directoryInput = this.modal.locator('input[placeholder*="Project"], input[placeholder*="\\\\"]').first()
...
export class RepoBrowserPage {
  ...
  constructor(page: Page) {
    this.page = page
    this.container = page.locator('[data-testid="repo-browser"], main:has-text("Repo Browser")').first()
...
export class FileExplorerWithRemotePage {
  ...
  constructor(page: Page) {
    this.page = page
    this.container = page.locator('[data-testid="file-explorer"], main:has-text("File Explorer")').first()
    this.showRemoteToggle = this.container.locator('button[title*="remote"], button[title*="Remote"]').first()
  ...
  async clickContextMenuItem(itemText: string): Promise<void> {
    const menuItem = this.page.locator(`[role="menuitem"]:has-text("${itemText}"), .context-menu button:has-text("${itemText}")`).first()
