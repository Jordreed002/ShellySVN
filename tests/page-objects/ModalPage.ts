...
export class ModalPage {
  ...
  getPrimaryButton(): Locator {
    return this.footer
      .locator(
        '.btn-primary, button:has-text("Checkout"), button:has-text("Open"), button:has-text("Save")'
      )
      .first();
  }
...
export class AddRepoModal extends ModalPage {
  ...
  constructor(page: Page) {
    ...
    this.urlInput = this.modal
      .locator('input[placeholder*="URL"], input[placeholder*="svn"]')
      .first();
...
export class SettingsDialog extends ModalPage {
  ...
  constructor(page: Page) {
    super(page);
    this.generalTab = this.modal
      .locator('button:has-text("General"), [data-tab="general"]')
      .first();
    this.authTab = this.modal.locator('button:has-text("Auth"), [data-tab="auth"]').first();
    this.appearanceTab = this.modal
      .locator('button:has-text("Appearance"), [data-tab="appearance"]')
      .first();
  }
