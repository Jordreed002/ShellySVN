...
describe('getRelativePath', () => {
  ...
  describe('Windows paths', () => {
    ...
    it('handles UNC paths', () => {
      expect(getRelativePath('\\\\server\\share\\folder\\file.ts', '\\\\server\\share')).toBe(
        'folder/file.ts'
      );
    });
  });
  ...
  describe('edge cases', () => {
    ...
    it('handles paths with spaces', () => {
      expect(getRelativePath('/repo/my project/src/file.ts', '/repo/my project')).toBe(
        'src/file.ts'
      );
    });
  });
...
describe('resolveRemoteUrlToLocalPath', () => {
  ...
  describe('edge cases', () => {
    it('returns null for empty inputs', () => {
      ...
      expect(
        resolveRemoteUrlToLocalPath('https://svn.example.com/repo/file.ts', '', repositoryRoot)
      ).toBeNull();
      expect(
        resolveRemoteUrlToLocalPath('https://svn.example.com/repo/file.ts', workingCopyRoot, '')
      ).toBeNull();
    });
...
describe('isUrlInRepository', () => {
  ...
  it('returns true for URL in repository', () => {
    expect(isUrlInRepository('https://svn.example.com/repo/trunk/file.ts', repositoryRoot)).toBe(
      true
    );
  });
