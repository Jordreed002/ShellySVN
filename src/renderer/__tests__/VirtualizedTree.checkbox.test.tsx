...
import { VirtualizedTree, type TreeNode, type CheckboxSelectionProps } from '../src/components/ui/VirtualizedList'
...
describe('VirtualizedTree Checkbox Selection', () => {
  describe('basic selection', () => {
    ...
    it('deselecting a node removes it from selectedKeys', () => {
      const onSelectionChange = vi.fn()
      const allPaths = [
        '/root', '/root/src', '/root/lib',
        '/root/src/file1.ts', '/root/src/file2.ts',
        '/root/lib/file3.ts', '/root/README.md'
      ]
