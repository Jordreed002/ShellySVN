						...
						{selectedNode && (
							<div className="w-72 bg-bg-secondary border-l border-border p-4">
								...
								<div className="mt-6 space-y-2">
									...
									{selectedNode.kind === "dir" && workingCopyContext && !isInWorkingCopy(selectedNode) && (
										<button
											type="button"
									...
									<button
										type="button"
										onClick={() =>
											window.api.app.openExternal(selectedNode.url)
										}
			...
			{!isValidUrl && (
				<div className="flex-1 flex flex-col items-center justify-center text-center p-8">
					...
					<p className="text-sm text-text-secondary max-w-sm mb-6">
						Enter a repository URL above to browse files and folders directly on
						the server, without needing a working copy.
					</p>
