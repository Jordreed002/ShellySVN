          ...
          {isAdding ? (
            <div className="bg-bg-tertiary rounded-lg p-4 space-y-3">
              ...
              <div className="flex justify-end gap-2">
                <button onClick={() => setIsAdding(false)} className="btn btn-secondary btn-sm">
                  Cancel
                </button>
                <button
                  onClick={handleAdd}
            ...
            <button onClick={() => setIsAdding(true)} className="btn btn-secondary w-full">
              <Plus className="w-4 h-4" />
              Add Bookmark
            </button>
          )}
            ...
            <div className="border border-border rounded-lg overflow-hidden">
              ...
              <div className="divide-y divide-border max-h-[300px] overflow-auto">
                {bookmarks.map((bookmark) => (
                  <div key={bookmark.path} className="px-4 py-3 hover:bg-bg-tertiary">
                        ...
                        {editingPath === bookmark.path ? (
                          ...
                          <>
                            <div className="flex items-center gap-2">
                              ...
                              <span className="font-medium text-text">{bookmark.name}</span>
                            </div>
