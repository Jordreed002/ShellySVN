      ...
      <div className="flex items-center gap-4 px-4 py-2">
                      ...
                      : status === 'A'
                        ...
                        : status === 'D'
                          ...
                          : status === 'C'
                            ...
                            : status === '?'
                              ? 'bg-svn-unversioned/20 text-svn-unversioned'
        ...
        {error && (
          <div className="flex items-center gap-2 text-error text-sm animate-fade-in">
            ...
            <button onClick={() => setError(null)} className="hover:text-error/80">
              <X className="w-3 h-3" />
            </button>
          </div>
        )}
        ...
        {/* Clear selection */}
        <button onClick={onClearSelection} className="btn-icon-sm" title="Clear selection (Esc)">
          <X className="w-4 h-4" />
        </button>
      </div>
    </div>
