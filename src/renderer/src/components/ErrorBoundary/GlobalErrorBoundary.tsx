...
> {
  ...
  render(): ReactNode {
    ...
    const { hasError, error, errorInfo, classifiedError, retryCount, isRetrying, copied } =
      this.state;
          ...
          <div className="max-w-2xl w-full">
            ...
            {classifiedError?.suggestions && classifiedError.suggestions.length > 0 && (
              <div className="bg-surface-elevated rounded-lg p-4 mb-6">
                <p className="text-sm font-medium text-text-secondary mb-3">What you can try:</p>
              ...
              <div className="bg-bg-tertiary rounded-lg overflow-hidden">
                <div className="flex items-center justify-between px-4 py-3 border-b border-border">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-text-secondary">Developer Info</span>
                  </div>
                  <button
                    type="button"
