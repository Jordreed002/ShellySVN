...
describe('StreamingDiffParser', () => {
  ...
  describe('hunk parsing', () => {
    ...
    it('should identify added lines', async () => {
      ...
      const addedLines = result.files[0].hunks[0].lines.filter((l) => l.type === 'added');
    ...
    it('should identify removed lines', async () => {
      ...
      const removedLines = result.files[0].hunks[0].lines.filter((l) => l.type === 'removed');
    ...
    it('should identify context lines', async () => {
      ...
      const contextLines = result.files[0].hunks[0].lines.filter((l) => l.type === 'context');
