      ...
      <div className="flex flex-col gap-4 pl-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="max-w-3xl space-y-2">
          ...
          <p className="text-[0.98rem] leading-7 text-[var(--foreground)]">
            ShellySVN is currently best for{' '}
            <strong className="font-medium text-[var(--foreground-strong)]">
              browsing, sparse checkout, diffs, and packaging
            </strong>
            . For critical commits, keep your existing SVN client around until the preview
            stabilises.
          </p>
        </div>
        <Link href="/roadmap" className="btn btn-secondary shrink-0">
          Known limitations →
        </Link>
      </div>
    </div>
